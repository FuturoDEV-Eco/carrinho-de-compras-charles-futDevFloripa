...
const ProductController = {
  createProduct: async (req, res) => {
    const { name, amount, color, voltage, description, price, category_id } =
      req.body;
    try {
      const newProduct = await connection.query(
        'INSERT INTO products (name, amount, color, voltage, description, price, category_id) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
